...
| Mobile Lighthouse score | 50–75 (typical) | 90+ |
| Security risk | High (plugin vulnerabilities) | Low |
| You own the code | Partially | Fully |
| Looks like a template | Often | Never |
| Needs ongoing maintenance | Yes — plugins, updates, backups | Minimal |
| AI search ready (llms.txt) | Plugin needed, inconsistent | Built in |
| WhatsApp lead flow | Plugin needed | Built in |
