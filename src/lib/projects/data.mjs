...
export const projects = [
  {
    ...
    next: { slug: "northpeak", name: "North Peak Power Systems", label: "Next · 07" },
  },
  {
    slug: "inhimalayas",
    // Personal project. Its live site was rebranded to "Himachal BNB" and now renders with broken
    // images, so it is pulled from the /portfolio work list (`unlisted`) but kept as a case study
    // here so GEO interlinks (blogs, service pages, llms.txt) stay valid. Re-list once the live
    // site is fixed and re-shot. (2026-07-24)
    personal: true,
    unlisted: true,
    num: "08", name: "InHimalayas", category: "Travel · Booking", year: "2025",
    ...
    description: "A revenue-share booking platform for resorts and stays across the Himalayas. Built for global travellers — LLM files and GEO drove a spike in AI traffic.",
  ...
  },
  {
    ...
    // Personal project — shown on /portfolio under "Personal projects", kept off the homepage deck.
    personal: true,
    num: "07", name: "North Peak Power Systems", category: "Infra · Dashboard", year: "2025",
    ...
    next: { slug: "inhimalayas", name: "InHimalayas", label: "Next · 08" },
  },
  {
    slug: "cultxberserk",
