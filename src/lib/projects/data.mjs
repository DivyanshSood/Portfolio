...
export const projects = [
  ...
  },
  {
    ...
    title: "CultXberserk — Berserk-inspired apparel brand · Case study · Divyansh Sood",
    description: "A gothic apparel label built around the world of Berserk. Hand-numbered drops (0001–0666), 13 designs never reprinted, a 'Brand of Sacrifice' seal at the neckline. Custom-coded storefront — no Shopify theme.",
