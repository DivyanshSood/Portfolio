/* AUTO-GENERATED post manifest — single source for the blog index, RSS
   feed and each post's "read next" link. Edit a post's prose in its own
   src/pages/blog/<slug>.astro; edit its metadata here. Ordered newest-first. */
